#############################################################################
# Makefile for building: coinwayne-qt
# Generated by qmake (2.01a) (Qt 4.8.4) on: Thu Feb 13 18:47:05 2014
# Project:  coinwayne-qt.pro
# Template: app
# Command: c:\Qt\4.8.4\bin\qmake.exe "USE_UPNP=- coinwayne-qt.pro" -o Makefile coinwayne-qt.pro
#############################################################################
...
Makefile: coinwayne-qt.pro  ../Qt/4.8.4/mkspecs/win32-g++/qmake.conf ../Qt/4.8.4/mkspecs/features/device_config.prf \
	...
	$(QMAKE) "USE_UPNP=- coinwayne-qt.pro" -o Makefile coinwayne-qt.pro
