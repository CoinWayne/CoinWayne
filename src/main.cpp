...
uint256 hashGenesisBlock("0x7b00f06893ef428c3eaaca38eb2498f11cbc97cbdd0ce9360ce2961970e6b7d0");
...
const string strMessageMagic = "CoinWayne Signed Message:\n";
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal CoinWayne miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "CoinWayne", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x7b00f06893ef428c3eaaca38eb2498f11cbc97cbdd0ce9360ce2961970e6b7d0");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "CoinWayne is finally released";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1392233937; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2264253;

        if (fTestNet)
        {
            block.nTime    = 1392233937;
            block.nNonce   = 440824;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xbd61b55935e7caf6779030436e402325745c54312b6ca7d20f44155cbc93e4fe"));
